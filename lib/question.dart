                ...
                child: new TextButton(
                  ...
                  onPressed: () async {
                    if (selectedItems != null &&
                      ...
                      print('초기');
                      var newset = {
                        "평단": priceController.text,
                        "종목": selectedItems,
                        "설명": why,
                        "닉네임": nickController.text,
                        "답변": 'X',
                      };
                      await firestore
                          .collection('00question')
                          .doc('질문')
                          .get()
                          .then((DocumentSnapshot ds) {
                        try {
                          set = ds[_auth.currentUser!.uid];
                        } catch (e) {
                          print('에러뜸');
                        }
                      });

                      if (set.containsKey(date)) {
                        set[date].add(newset);
                      } else {
                        set[date] = [];
                        set[date].add(newset);
                      ...
                      await firestore
                          .collection('00question')
                          .doc('질문')
                          .update({_auth.currentUser!.uid: set});
  ...
  Widget _List() {
    return new StreamBuilder(
        ...
        builder: (BuildContext context,
          ...
          var imsi = data![_auth.currentUser!.uid];
          var keyss = [];
          if (imsi != null) {
            keyss = imsi.keys
                .where((k) =>
                            ...
                            child: Container(
                              child: Container(
                                ...
                                child: Container(
                                  width:260,
                                  child: Card(
                                    color: Color.fromRGBO(204, 255, 229, 1),
                                    child: Padding(
